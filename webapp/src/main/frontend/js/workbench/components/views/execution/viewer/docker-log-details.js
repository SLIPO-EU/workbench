...
export default class DockerLogDetails extends React.Component {
  ...
  static propTypes = {
    hideDockerLogDetails: PropTypes.func,
    logs: PropTypes.arrayOf(PropTypes.object).isRequired,
    resetSelectedFile: PropTypes.func.isRequired,
    selectedRow: PropTypes.number,
    selectedLog: PropTypes.object,
    selectRow: PropTypes.func.isRequired,
    viewLog: PropTypes.func.isRequired,
  ...
  handleRowAction(rowInfo, e, handleOriginal) {
    ...
    switch (e.target.getAttribute('data-action')) {
      ...
      case 'file-view':
        this.props.viewLog(rowInfo.row.id);
        break;
  ...
  render() {
    ...
    const file = this.props.selectedRow && this.props.logs.find((f) => f.id === this.props.selectedRow);
          ...
          <CardBody>
            <Row className="mb-4">
              <Col>
                ...
                <span>{this.props.step.name + ' - Logs'}</span>
              </Col>
              {this.props.hideDockerLogDetails &&
                <Col>
