package eu.slipo.workbench.rpc.integration.workflow.mergesort;
...
import eu.slipo.workbench.rpc.config.BatchConfig;
import eu.slipo.workbench.rpc.config.TaskExecutorConfig;
import eu.slipo.workbench.rpc.jobs.SplitFileJobConfiguration;
import eu.slipo.workbench.rpc.service.SimpleJobService;
import eu.slipo.workbench.rpc.service.workflow.EventBasedWorkflowScheduler;
import eu.slipo.workbench.rpc.service.workflow.WorkflowScheduler;
import eu.slipo.workbench.rpc.workflow.Workflow;
import eu.slipo.workbench.rpc.workflow.WorkflowBuilderFactory;
...
import eu.slipo.workbench.rpc.workflow.WorkflowExecutionCompletionListenerSupport;
import eu.slipo.workbench.rpc.workflow.WorkflowExecutionEventListenerSupport;
...
@SpringBootTest(
    ...
    classes = {    
        ...
        BatchConfig.class,
        SimpleJobService.class,
        
        WorkflowBuilderFactory.class, 
        EventBasedWorkflowScheduler.class,
        SplitFileJobConfiguration.class,
        
        eu.slipo.workbench.rpc.jobs.examples.mergesort.MergeFilesJobConfiguration.class, 
        eu.slipo.workbench.rpc.jobs.examples.mergesort.SortFileJobConfiguration.class, 
        eu.slipo.workbench.rpc.jobs.examples.mergesort.StatFileJobConfiguration.class,
        eu.slipo.workbench.rpc.workflow.examples.mergesort.WorkflowBuilderFactory.class,
    })
public class WorkflowSchedulerTests
{
    ...
    {
        final Path fixturePath = Paths.get("integration/workflow/mergesort");
    ...
    private eu.slipo.workbench.rpc.workflow.examples.mergesort.WorkflowBuilderFactory workflowBuilderFactory;
