package eu.slipo.workbench.rpc.util.digraph;

import java.util.function.IntFunction;

import eu.slipo.workbench.rpc.util.digraph.TopologicalSort.CycleDetected;
import eu.slipo.workbench.rpc.util.digraph.ExportDependencyGraph.Direction;
import eu.slipo.workbench.rpc.util.digraph.ExportDependencyGraph.NodeAttributes;
...
public class DependencyGraphs
{
     ...
     */
    public static Iterable<Integer> topologicalSort(DependencyGraph graph) throws CycleDetected
    {
     ...
     */
    public static void check(DependencyGraph graph) throws CycleDetected
    {
